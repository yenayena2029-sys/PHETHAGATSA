...
export default function SignupClient({ initialSettings }: { initialSettings: any }) {
  ...
  return (
    <div className="container" style={styles.container}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Join us and explore premium collections.</p>
        ...
        {/* Demo Mode alert banner when config is empty */}
        {!settings.firebaseConfig && (showGoogle || showFacebook || showApple || showPhone) && (
          <div style={styles.demoNotice}>
            <strong>Demo Mode Active:</strong> Firebase Config is empty. Social and Phone buttons will register instantly using mock profiles.
          </div>
        )}
        ...
        {phoneAuthActive ? (
          ...
          showEmail ? (
            ...
            <div style={{ textAlign: "center", color: "var(--text-muted)", padding: "16px 0", fontSize: "14px" }}>
              Email Registration is disabled. Please choose one of the options below.
            </div>
          )
        )}
